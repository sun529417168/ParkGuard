...
public class EmotionInputDetector {
    ...
    private View ll_emotion_add_layout;
...
//                }
                if (s.length() > 0) {
                    ll_emotion_add_layout.setVisibility(View.GONE);
                    mSendButton.setVisibility(View.VISIBLE);
                } else {
                    ll_emotion_add_layout.setVisibility(View.VISIBLE);
                    mSendButton.setVisibility(View.GONE);
                }
            }
    ...
    public EmotionInputDetector bindToAddButton(View addButton, View ll_emotion_add_layout) {
        mAddButton = addButton;
        this.ll_emotion_add_layout = ll_emotion_add_layout;
